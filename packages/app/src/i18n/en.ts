export const dict = {
  ...
  "settings.site.section.connection": "Connection",
  "settings.site.row.connectionType.title": "Connection Type",
  "settings.site.row.connectionType.description": "Choose how to connect to the site",
  "settings.site.connectionType.local": "Local",
  "settings.site.connectionType.ssh": "SSH",
  "settings.site.section.local": "Local",
  "settings.site.row.localPath.title": "Local Path",
  "settings.site.row.localPath.description": "Path to the local site directory",
  "settings.site.row.localPath.placeholder": "/path/to/site",
  "settings.site.action.browse": "Browse",
  "settings.site.section.ssh": "SSH",
  "settings.site.row.host.title": "Host",
  "settings.site.row.host.description": "SSH host address",
  "settings.site.row.port.title": "Port",
  "settings.site.row.port.description": "SSH port number",
  "settings.site.row.username.title": "Username",
  "settings.site.row.username.description": "SSH username",
  "settings.site.row.authType.title": "Authentication Type",
  "settings.site.row.authType.description": "How to authenticate with the SSH server",
  "settings.site.ssh.authType.password": "Password",
  "settings.site.ssh.authType.privateKey": "Private Key",
  "settings.site.row.password.title": "Password",
  "settings.site.row.password.description": "SSH password",
  "settings.site.row.password.placeholder": "Enter password",
  "settings.site.row.privateKeyPath.title": "Private Key Path",
  "settings.site.row.privateKeyPath.description": "Path to the SSH private key file",
  "settings.site.row.remotePath.title": "Remote Path",
  "settings.site.row.remotePath.description": "Path to the site on the remote server",
  "settings.site.action.testConnection": "Test Connection",
